...
write.csv (titanic, file = "D:/Data_Visualization_S18/Assignment/Assignment 7_IntegratedAnalysisWidR/titanicNew.csv")
titanic<-read.csv("D:/Data_Visualization_S18/Assignment/Assignment 7_IntegratedAnalysisWidR/titanicNew.csv")
...
titanicNew<-read.csv("D:/Data_Visualization_S18/Assignment/Assignment 7_IntegratedAnalysisWidR/titanicNew.csv")
...
write.csv(titanicUpdated,file="D:/Data_Visualization_S18/Assignment/Assignment 7_IntegratedAnalysisWidR/titanicUpdated.csv")
...
plot(totwss,xlab="Number of Cluster",type="b",ylab="Total within sum of squares")

plot(btwss,xlab="Number of Cluster",type="b",ylab="Total between sum of squares")
